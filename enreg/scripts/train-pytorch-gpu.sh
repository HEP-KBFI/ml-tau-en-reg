...
apptainer exec -B /scratch/persistent/laurits --env PYTHONPATH=`pwd` --nv /home/software/singularity/pytorch.simg\:2024-02-13 python3 enreg/scripts/trainSimpleDNN.py
